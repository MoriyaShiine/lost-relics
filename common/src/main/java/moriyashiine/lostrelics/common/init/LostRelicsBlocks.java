...
public class LostRelicsBlocks {
	public static final Block JUNGLE_ALTAR = registerBlock(LostRelicsBlockItemIds.JUNGLE_ALTAR, settings -> new AltarBlock(settings, LostRelicsItemTags.JUNGLE_RELICS), ofFullCopy(Blocks.OBSIDIAN));
